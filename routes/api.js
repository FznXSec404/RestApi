...
loghandler = {
    notparam: {
        ...
        getApikey: 'gak punya apikey? chat gw aja yaaa di wa.me/6289666262976 , key nya gratis kok suu, jadi santuyy ajaa'
    },
    notkey: {
        status: false,
        creator: `${creator}`,
...
var len = 15
        ...
        var randomTextNumber = random+randomlagi+'---------OJAN'+'POJAN--GANS';
...
router.get('/find', async (req, res, next) => {
    ...
    if (apikey != 'ojanganz') return res.json(loghandler.invalidKey)
...
router.get('/tiktod', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'ojanganz') return res.json(loghandler.invalidKey)
